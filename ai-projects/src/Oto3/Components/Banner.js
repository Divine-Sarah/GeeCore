 ...
 <>
		...
		<div className="row justify-content-center">
			<div className="col-12 text-center">			
				<img src={Image} className="img-fluid mx-auto d-block logo" alt="logo"/>
				 ...
				 */}
				<h1 className="lg48 md40 sm30 xs25 w400 lh130 mt2" style={{color:"rgb(43 28 106)"}}>Introducing ‘Human-like’ All-In-One  <br className="d-none d-md-block"/> <span className="w700" style={{color:"rgb(43 28 106)"}}>AI Marketing Assistant</span></h1>
...
<div id="particles-js"></div>	
				...
				<div className="row m-0">
					...
					<div className="col-md-6 text-center padding0 align-self-center">				
						<div className="video-box">
							<img src={Video}className="img-fluid center-block videoBg" alt="videoBg"/>
	...
	<div className="mycontainer2">
		<div className="row justify-content-center">
			...
			<div className="col-12 text-center">
                      <h4 className="lg26 md24 sm20 xs18 w400 lh160" style={{ color: "rgb(43 28 106)" }}>AI Creates An Online ‘Ready-To-Profit’ Business Using Just A Keyword.  <br className="d-none d-md-block" /> Use In Your Business or <span className="w700" style={{ color: "rgb(43 28 106)" }}>Sell To Clients For Big Bucks!</span> </h4>
			</div>
		</div>
	</div>
	...
	<div className="mycontainer2 mt1">
		<div className="row justify-content-center">		
			...
			<div className="col-12 text-center mt3">
				<h2 className="lg34 md26 sm26 xs20 w700 lh170" style={{color:"rgb(43 28 106)"}}>All Upgrades Included ONLY</h2>	
					  <h1 className="lg42 md30 sm30 xs22 lh170 w700 " style={{ color: "rgb(43 28 106)" }}>When You Act NOW!</h1>
			</div>
		</div>
	</div>
				...
				<div className="mybutton mybutton-box">
					...
					<a href="#table" className="text-center xl40 lg38 md36 sm30 xs20 w700">
						<span className="mybutton-btn">
							...
							<span className="btn-arrow"><img src={Arrow} className="img-fluid center-block arrow" alt="arrow"/> </span> 
						</span> 
					</a>

				</div>
				
				<img src={Payment} className="img-fluid mx-auto d-block payment mt1" alt="payment"/>  
				<img src={Window} className="img-fluid mx-auto d-block window mt1" alt="window"/>  
